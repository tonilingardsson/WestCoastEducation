    ...
    const updateCourseList = async () => {
        ...
        `;
            ...
            editButton.addEventListener("click", () => {
                ...
                teacherId.value = courseToEdit.teacherId;
                editMode.active = true;
                editMode.courseId = course.id;


                // Set a variable to the editButton for edit-mode is on
                // So when the edit button is clicked, it will be true
                // And when the save/cancel button is clicked, it will be false
